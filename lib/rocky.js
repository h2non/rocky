...
Rocky.prototype.forward   =
Rocky.prototype.forwardTo = function (url) {
  this.opts.target = url
  return this
}

Rocky.prototype.replay   =
Rocky.prototype.replayTo = function (url, opts) {
...
// Mixin inherited methods implemented by Route
