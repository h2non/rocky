...
Route.prototype.host = function (host) {
  this.mw(middlewares.changeHost(host))
  return this
}

Route.prototype.toPath = function (path, args) {
  this.mw(middlewares.toPath(path, args))
  return this
}

Route.prototype.headers = function (headers) {
  this.mw(middlewares.extendheaders(headers))
  return this
}
